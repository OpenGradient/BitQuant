...
class TestPlugins(unittest.TestCase):
    ...
    def test_defillama(self):
        """Test DefiLlama tool functionality"""
        print("\n=== Testing DefiLlama Tools ===")
        
        # Initialize metrics just for pool testing
        metrics = DefiMetrics()
        
        try:
            # Attempt to refresh metrics for the pool tests, but continue even if it fails
            print("\nRefreshing metrics...")
            metrics.refresh_metrics()
            
            # Test getting pools with direct method (keep this one since it uses different approach)
