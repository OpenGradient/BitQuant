...
class TestFinancialAnalyticsTools(unittest.TestCase):
    ...
    def test_get_coingecko_price_history(self):
        response = get_coingecko_price_history(
            token_symbol="BTC",
    ...
    def test_btc_price_history_basic(self):
        ...
        btc_history = get_coingecko_price_history(
            token_symbol="BTC",
            candle_interval=CandleInterval.DAY,
            num_candles=30,
        )
    ...
    def test_eth_custom_interval(self):
        ...
        eth_history = get_coingecko_price_history(
            token_symbol="ETH",
    ...
    def test_small_data_limit(self):
        ...
        small_limit = 5
        small_history = get_coingecko_price_history(
            token_symbol="BTC",
